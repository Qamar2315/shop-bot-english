...
async def process_add_product(message: Message):
    ...
    await message.answer('Product Name?', reply_markup=markup)
...
async def process_image_url(message: Message, state: FSMContext):
    ...
    if message.text == back_message:
        ...
        await message.answer('Please send a product photo.')
...
async def process_price_invalid(message: Message, state: FSMContext):
    ...
    if message.text == back_message:
        ...
        async with state.proxy() as data:
            await message.answer("Change the image?", reply_markup=back_markup())

    else:
        await message.answer('Please provide a valid number for the price!')
...
async def show_products(m, products, category_idx):
    ...
    await m.answer('Would you like to add or delete anything?', reply_markup=markup)
